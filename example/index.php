...
try {
    ...
    $style = loadStyleSheet("ieee");
    $citeProc = new CiteProc($style, Locale::EN_US());
    $data = json_decode($dataString);
    $bibliography = $citeProc->render($data, Mode::BIBLIOGRAPHY());
...
<article>
    ...
    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et
        ...
        <?php echo $citeProc->render($data, Mode::CITATION(), json_decode('[{"id":"ITEM-4"}]')); ?>.</p>
    ...
    <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu
        ...
        <?php echo $citeProc->render($data, Mode::CITATION(), json_decode('[{"id":"ITEM-2"}]')); ?>.</p>
    ...
    <p>Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer
        ...
        <?php echo $citeProc->render($data, Mode::CITATION(), json_decode('[{"id":"ITEM-1"}]')); ?>.</p>

    <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu
        feugiat
        nulla facilisis <?php echo $citeProc->render($data, Mode::CITATION(), json_decode('[{"id":"ITEM-3"}]')); ?>.</p>
    ...
    <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est
        ...
        <?php echo $citeProc->render($data, Mode::CITATION(), json_decode('[{"id":"ITEM-3"},{"id":"ITEM-4"}]')); ?>.</p>
    ...
    <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu
        ...
        <?php echo $citeProc->render($data, Mode::CITATION(), json_decode('[{"id":"ITEM-3"}]')); ?>.</p>
